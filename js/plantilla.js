define(function (require) {
    return [
        {//Sistema Reproductor
            ...
            'pf' : '<div id="fondo"><div><img id="grafica" src="{{grafica}}"><div class="text_titulo">{{titulo}}</div><div class="text_matrix">{{teoria}}</div></div><button class="btn_atrasf btn_back">Atras</button></div>',
