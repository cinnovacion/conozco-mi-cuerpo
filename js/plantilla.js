define(function (require) {
    return [
        {//Sistema Reproductor
            ...
            'menu_srf' : '<div class="fondo"><button class="btn_back_menu btn_back">Menu</button><button class="boton" id="exploro_f"><h3 class="objeto">Exploro</h3></button><button class="boton" id="juego"><h3 class="objeto">Juego</h3></button></div>',
            ...
            'menu_srm' : '<div class="fondo"><button class="btn_back_menu btn_back">Menu</button><button class="boton" id="exploro_m"><h3 class="objeto">Exploro</h3></button><button class="boton" id="juego"><h3 class="objeto">Juego</h3></button></div>',
