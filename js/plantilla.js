define(function (require) {
    return [
        {//Sistema Reproductor
            ...
            'menu_srf' : '<div class="fondo"><button class="btn_back_menu btn_back">Menu</button><h1 class="objeto titulo">Sistema Reproductor Femenino</h1><button class="boton" id="exploro_f"><h3 class="objeto">Exploro</h3></button><button class="boton" id="juego_f"><h3 class="objeto">Juego</h3></button></div>',
            ...
            'menu_srm' : '<div class="fondo"><button class="btn_back_menu btn_back">Menu</button><h1 class="objeto titulo">Sistema Reproductor Masculino</h1><button class="boton" id="exploro_m"><h3 class="objeto">Exploro</h3></button><button class="boton" id="juego_m"><h3 class="objeto">Juego</h3></button></div>',
            ...
            'pmenu' : '<div class="fondo"><div><img id="grafica" src="{{grafica}}"><div class="text_titulo">{{titulo}}</div><p class="text_matrix">{{teoria}}</p></div><button class="btn_atras btn_back">Atras</button></div>',
